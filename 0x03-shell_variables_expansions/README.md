...
Write a script that prints the result of the addition of 128 with the value sotred in the environment variable `TRUEKNOWLEDGE`, followed by a new line.
...
Write a script that pritns every other line from the input, starting with the first line.
...
Write a shell script that adds the two numbers sotred in the environment variables `WATER` and `STIR` and prints the result.
